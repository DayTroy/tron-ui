...
import { TronDrawerService, TronIconComponent } from '../../../tron-ui/src/public-api';
import { CATALOG_NAV } from './catalog-nav';

@Component({
  selector: 'app-root',
  imports: [RouterOutlet, RouterLink, RouterLinkActive, NgTemplateOutlet, TronIconComponent],
